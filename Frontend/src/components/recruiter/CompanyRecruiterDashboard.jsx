...
const CompanyRecruiterDashboard = () => {
  ...
  useEffect(() => {
    // Safety check: ensure user exists and has companyId
    if (!user) {
      console.log('CompanyRecruiterDashboard - No user found in Redux state');
      setLoading(false);
    ...
    if (!user.companyId) {
      console.log('CompanyRecruiterDashboard - User has no companyId:', user);
      setLoading(false);
    ...
    <div className="card-elevated p-6 animate-scale-in">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <button
          ...
          className="flex flex-col items-center space-y-2 p-4 text-center bg-secondary hover:bg-accent rounded-lg transition-colors"
        >
    ...
    <div className="card-elevated p-6 animate-fade-in-up">
      ...
      <div className="space-y-4">
        {recentJobs && Array.isArray(recentJobs) && recentJobs.length > 0 ? (
            ...
            <div key={job._id || job.id} className="flex items-center space-x-3 p-4 bg-gray-50 rounded-lg border border-gray-200">
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className={`px-3 py-1 text-xs rounded-full font-medium ${job.status === 'Active' ? 'bg-green-100 text-green-800' :
          ...
          <EmptyState
            icon={FileText}
            title="No recent jobs posted"
            description="Start posting jobs to see activity here"
            action={
              <GradientButton
                onClick={() => navigate('/app/recruiter/post-job')}
                variant="gradient"
  ...
  return (
    <div className="flex-1 w-full bg-gray-50 px-4 sm:px-6 lg:px-8 py-4">
      <div className="max-w-[1600px] mx-auto">
        {/* Header */}
        <div className="mb-8 animate-fade-in">
          <h1 className="text-4xl font-bold gradient-text mb-2">Company Dashboard</h1>
          <p className="text-muted-foreground text-lg">Welcome back, {user?.fullname}. Here's what's happening with your company.</p>
        </div>
        ...
        <div className="mb-8">
          <div className="bg-gradient-to-r from-secondary to-accent rounded-lg shadow-md p-6 border border-border">
        ...
        <div className="mb-8 animate-fade-in-up">
          <div className="card-elevated p-6">
            <h3 className="text-lg font-semibold text-foreground mb-4">Company Achievements</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="text-center p-4 bg-secondary rounded-lg border border-border">
                ...
                <p className="text-lg font-bold text-foreground">{stats.projectSuccessRate || 0}%</p>
                  ...
                  <div key={project._id || index} className="flex items-center space-x-3 p-4 bg-gray-50 rounded-lg border border-gray-200">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className={`px-3 py-1 text-xs rounded-full font-medium ${project.status === 'In Progress' ? 'bg-blue-100 text-blue-800' :
