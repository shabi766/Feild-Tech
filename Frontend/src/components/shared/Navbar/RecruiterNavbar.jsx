...
import { Plus, Search, Building2, Users, Briefcase, UserPlus, FileText, Building, Calendar, ChevronDown } from 'lucide-react';
...
const RecruiterNavbar = ({ user, setLogoutFlag }) => {
    ...
    const createMenuItems = [
        { path: '/app/recruiter/clients/create', label: 'Post Client', icon: UserPlus, desc: 'Add a new client' },
        { path: '/app/recruiter/projects/create', label: 'Post Project', icon: FileText, desc: 'Create a project' },
        { path: '/app/recruiter/jobs/create', label: 'Post Jobs', icon: Briefcase, desc: 'Post a new job listing' },
        { path: '/app/recruiter/companies/create', label: 'Post Companies', icon: Building, desc: 'Register a company' }
    ];

    const workMenuItems = [
        { path: '/app/recruiter/job-calendar', label: 'Job Calendar', icon: Calendar, desc: 'Schedule & timeline' },
        { path: '/app/recruiter/jobs', label: 'Jobs', icon: Briefcase, desc: 'Manage job listings' },
        { path: '/app/recruiter/clients', label: 'Clients', icon: UserPlus, desc: 'Client directory' },
        { path: '/app/recruiter/projects', label: 'Projects', icon: FileText, desc: 'Project management' }
    ];
