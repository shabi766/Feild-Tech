                            ...
                            <div className="flex-1 text-center lg:text-left">
                                ...
                                >
                                    ...
                                    <motion.button
                                        ...
                                        className="p-4 bg-gradient-to-r from-primary to-primary-dark text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex-shrink-0"
                        ...
                        <div className="flex flex-wrap gap-3">
                            {user?.profile?.skills?.length > 0 ? (
                                user.profile.skills.map((skill, index) => (
                                    ...
                                    >
                                        <Badge className="bg-gradient-to-r from-primary to-primary-light text-white border-0 px-4 py-2 text-sm font-medium">
                                            {skill}
                                        </Badge>
                                    </motion.div>
                                ))
                    ...
                    {user?.role === 'Recruiter' && (
                        ...
                        >
                            ...
                            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                                <motion.div
                                    className="p-6 bg-gradient-to-br from-secondary to-accent rounded-2xl border border-border"
                                    whileHover={{ scale: 1.02, y: -2 }}
                                    transition={{ type: "spring", stiffness: 300 }}
                                >
                            ...
                            <div className="mt-6 text-center">
                                <Button
                                    ...
                                    className="bg-gradient-to-r from-primary to-primary-dark hover:from-primary-dark hover:to-primary text-white px-8 py-3 rounded-xl font-semibold"
                                >
