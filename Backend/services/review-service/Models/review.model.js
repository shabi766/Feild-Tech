...
const reviewSchema = new mongoose.Schema({
    // Job reference (no ref - belongs to Workorder Service)
    jobId: {
        type: mongoose.Schema.Types.ObjectId,
        required: true
    },
    
    // Who is being reviewed (technician) - no ref - belongs to Auth Service
    technicianId: {
        type: mongoose.Schema.Types.ObjectId,
        required: true
    },
    
    // Who is giving the review (recruiter/client) - no ref - belongs to Auth Service
    reviewerId: {
        type: mongoose.Schema.Types.ObjectId,
        required: true
    },
